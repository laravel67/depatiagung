        ...
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active" id="nav-profile-tab" data-toggle="tab" data-target="#nav-profile"
                    ...
                    aria-selected="true"><strong>Profile</strong></button>
                ...
                <button class="nav-link" id="nav-logo-tab" data-toggle="tab" data-target="#nav-logo" type="button"
                    role="tab" aria-controls="nav-logo" aria-selected="false"><strong>Lambang/Logo</strong>
                </button>
                <button class="nav-link" id="nav-hymne-tab" data-toggle="tab" data-target="#nav-hymne" type="button"
                    role="tab" aria-controls="nav-hymne" aria-selected="false"><strong>Hymne</strong>
                </button>
            </div>
        </nav>
        <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade mt-2" id="nav-deskripsi" role="tabpanel" aria-labelledby="nav-deskripsi-tab">
                <article align="justify" class="blockquote">
                    <p>
                        Ponpes Salafiyah Depati Agung merupakan salah satu pondok pesantren yang ada di Kabupaten Merangin.
                        Adapun belajar
                        mengajar di ponpes ini menggunakan kurikulum yang berlaku di tambah dengan ilmu agama. Ada juga
                        kegiatan-kegiatan
                        ekstrakulikuler sekolah untuk santri seperti karate, basket, futsal, grup belajar dan lainnya.
                    </p>
                    <p>
                        Ponpes Salafiyah Depati Agung memiliki staf pengajar uztad/uztazah serta guru yang kompeten pada
                        bidang pelajarannya
                        masing-masing sehingga berkualitas dan menjadi salah satu pesantren terbaik di Kabupaten Merangin.
                        Tersedia juga
                        berbagai fasilitas seperti ruang kelas yang nyaman, asrama yang nyaman, laboratorium praktikum,
                        perpustakaan, lapangan
                        olahraga, kantin, masjid dan lainnya.
                    </p>
                    <p>
                        Segera kunjungi ponpes terdekat ini untuk info pendaftaran, biaya pendaftaran, info biaya SPP, info
                        kurikulum, info
                        pesantren di Kabupaten Merangin, nomor NPSN dan lainnya. Anda juga bisa menghubungi kontak atau
                        mengakses link <a href="{{ route('ppdb.home') }}">PPDB</a>.
                    </p>
                </article>
            </div>
