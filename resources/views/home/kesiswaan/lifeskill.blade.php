...
<div class="my-3 p-3 bg-white rounded box-shadow">
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="fisik-tab" data-toggle="tab" data-target="#fisik" type="button" role="tab"
                aria-controls="fisik" aria-selected="true"><h4>Fisik</h4></button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="nonfisik-tab" data-toggle="tab" data-target="#nonfisik" type="button" role="tab"
                aria-controls="nonfisik" aria-selected="true">
                <h4>Non Fisik</h4>
            </button>
        </li>
    </ul>
        ...
        <div class="tab-pane fade show active" id="fisik" role="tabpanel" aria-labelledby="fisik-tab">
            ...
            <div class="mb-2 border-bottom p-2" data-aos="zoom-in" data-aos-duration="500">
                <div class="row">
                    <div class="col-md-4">
                        @if ($post->image)
                        <img src="{{ asset('storage/'.$post->image) }}" alt="" width="300" height="300" class="img-fluid">
                        @else
