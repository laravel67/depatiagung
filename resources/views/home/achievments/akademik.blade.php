    ...
    <div class="card-body">
        <div class="container marketing">
            ...
            <div class="row featurette">
                <div class="col-md-7 {{ $i % 2 == 0 ? 'order-md-2' : '' }}" data-aos="flip-up" data-aos-duration="10000">
                ...
                <div class="col-md-5 order-md-1">
                    @if ($post->image)
                    <img data-aos="zoom-in" data-aos-duration="5000" src="{{ asset('storage/'.$post->image) }}" width="500"
                        height="500" style="overflow: hidden" class="img-fluid">
                    @else
