            ...
            <div class="row mb-3 justify-content-evenly d-flex">
                    ...
                    <div class="footer-pad">
                        ...
                        <ul class="list-unstyled">
                            <li style="list-style: square;">
                                Ponpes Salafiyah Depati Agung beralamat di Pulau Raman, Muara Siau, Merangin Regency, Jambi 37371, Indonesia.
                            </li>
                            <li style="list-style: square;">
                ...
                <div class="col-md-3">
                    ...
                    <ul class="social-network social-circle">
                        <li><a href="https://web.facebook.com/pps.depatiagung.3" target="_blank" class="icoFacebook" title="Facebook"><i
                                    class="fa-brands fa-facebook-f"></i></a></li>
                        <li><a href="https://www.instagram.com/pps.depati.agung/" target="_blank" class="icoIntagsram" title="Instagram"><i
                                    class="fa-brands fa-instagram"></i></a></li>
                        <li><a href="#" class="icoTwitter" title="Twitter"><i class="fa-brands fa-twitter"></i></a></li>
                        <li><a href="https://www.youtube.com/@ppsdepatiagung3797" target="_blank" class="icoYoutube" title="Youtube"><i
